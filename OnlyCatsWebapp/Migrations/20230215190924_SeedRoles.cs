...
namespace OnlyCatsWebapp.Migrations
{
    public partial class SeedRoles : Migration
    {
        ...
        private void SeedUser(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                VALUES 
                (N'{User1Id}', N'test2@test.pl', N'TEST2@TEST.PL', N'test2@test.pl', N'TEST2@TEST.PL', 0,
            ...
            migrationBuilder.Sql(
                ...
                [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount])
                VALUES 
                (N'{User2Id}', N'test1@test.pl',N'TEST1@TEST.PL', N'test1@test.pl', N'TEST1@TEST.PL', 0, 
                N'AQAAAAEAACcQAAAAEDGQ5wwj6Iz0lXHIZ5IwuvgSO88jrSBT1etWcDYjJN5CBNDKvddZcEeixYBYmcdFag==', 
                N'YUPAFWNGZI2UC5FOITC7PX5J7XZTAZAA', N'8e150555-a20d-4610-93ff-49c5af44f749', NULL, 0, 0, NULL, 1, 0)");
        }
